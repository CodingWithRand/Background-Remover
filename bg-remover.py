...
print("Welcome to an Image Background remover program!\n")
...
print("This program is made in python. By import the API from \"remove.bg\" \n"
      ...
      "You can decide whether to use the remove.bg API or Pillow python package\n")

print("The remove.bg API is an Artificial Intelligence API that has been trained enough to select the main object, and can remove"
...
print("(btw, pls consider use the pillow package. if you use the remove.bg, i'll have to pay for it TT)\n")
